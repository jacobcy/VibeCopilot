    ...
    def _convert_to_entities(self, parse_result: Dict[str, Any], file_path: Path) -> Dict[str, Any]:
        ...
        for block in parse_result.get("blocks", []):
            if block["type"] == "heading":
                ...
                # 添加文档与概念的关系
                result["relations"].append({"source": rel_path, "target": block["content"], "type": "mentions"})
    ...
    def process_documents(self) -> None:
        ...
        for md_file in self.source_dir.rglob("*.md"):
            ...
            try:
                ...
                parse_result = parse_file(str(md_file), content_type="document", parser_type="ollama", model=self.model)
