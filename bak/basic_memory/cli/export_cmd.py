...
from adapters.basic_memory.config import DEFAULT_EXPORT_PATH, DEFAULT_OBSIDIAN_CONFIG, EXPORTER_TYPE_MAPPING
...
def handle_export(args):
    ...
    try:
        if target_path.is_file():
            # 导出单个文件
            export_file(target_path, exporter_type=args.format, output_dir=args.output, config=config)
