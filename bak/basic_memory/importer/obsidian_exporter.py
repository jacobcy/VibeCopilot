...
from adapters.basic_memory.exporters.obsidian_exporter import ObsidianExporter as NewObsidianExporter
...
class ObsidianExporter:
    ...
    def export_document(
        ...
        try:
            # 转换为新API所需的格式
            entity = self._convert_to_entity_format(original_path, source_dir, metadata, observations, relations)
