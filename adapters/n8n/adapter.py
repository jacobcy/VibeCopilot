...
class N8nAdapter:
    ...
    def update_workflow(
        ...
        """
        try:
            return self._make_request("PUT", f"api/v1/workflows/{workflow_id}", workflow_data)
        except RequestException:
    ...
    def trigger_workflow(
        ...
        """
        try:
            return self._make_request("POST", f"api/v1/workflows/{workflow_id}/execute", payload)
        except RequestException:
