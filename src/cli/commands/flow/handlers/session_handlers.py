...
from src.flow_session.cli import close_session, delete_session, list_sessions, show_session
    ...
    try:
        ...
        try:
            ...
            if action == "list":
                ...
                result = list_sessions(status, workflow, format_type, verbose, agent_mode)
                ...
                result = show_session(session_id, format_type, verbose, agent_mode)
                return True, "", result  # 空消息，表示已输出
