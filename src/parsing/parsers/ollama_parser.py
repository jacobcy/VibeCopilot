...
class OllamaClient:
    ...
    async def generate(self, prompt, model=None, temperature=0.2):
        """模拟 Ollama 生成接口"""
        # 这里仅作为示例，实际应调用 Ollama API
        return {"response": "模拟的 Ollama 响应", "model": model or self.model}
