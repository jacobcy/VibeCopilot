...
def init_memory_items():
    ...
    items = [
        ...
        {"title": "数据库设计文档", "content": "数据库采用SQLite作为存储引擎，主要包含规则、模板、工作流等核心表。", "content_type": "text", "tags": "数据库,设计,文档", "source": "技术文档"},
        {"title": "开发规范说明", "content": "项目遵循PEP8规范，使用black进行代码格式化，所有函数必须有文档字符串。", "content_type": "text", "tags": "规范,开发,文档", "source": "开发文档"},
    ]
